...
#
# sns.set()
sns.set(font_scale=2.2, rc={'axes.facecolor': (0.90, 0.90, 0.90)})

font_path = '/home/user/.local/share/fonts/LibertinusSerif-Regular.otf'
# font_path = '/home/user/.local/share/fonts/LibertinusSerifDisplay-Regular.otf'
